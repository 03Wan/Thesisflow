...
const navigation: NavGroup[] = [
  { label: "准备", items: [{ label: "项目总览", to: "/overview", icon: LayoutDashboard }, { label: "论文要求", to: "/requirements", icon: ShieldCheck }, { label: "选题", to: "/topic", icon: NotebookPen }, { label: "任务书", to: "/task-book", icon: ClipboardCheck }] },
  ...
  { label: "修改", items: [{ label: "导师指导", to: "/guidance", icon: MessageSquareMore, badge: 2 }, { label: "修改任务", to: "/revisions", icon: ListChecks, badge: 3 }, { label: "全文智评", to: "/compliance", icon: SearchCheck }, { label: "引用核验", to: "/advisor-review", icon: FileCheck2 }, { label: "格式检查", to: "/reviewer-review", icon: CheckCircle2 }, { label: "版本历史", to: "/version-history", icon: Archive }] },
